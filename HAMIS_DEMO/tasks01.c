...
/*-----------------------------------------------------------*/
	...
	BaseType_t xReturn;
        ...
        regTaskStart(pxTaskCode, uxPriority, pxNewTCB->uxTCBNumber, pxNewTCB, pvParameters, stopTrack);
